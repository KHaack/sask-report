...
Coding with \LaTeX (ShareLaTeX Version)\\[2cm]
\end{flushleft}
\rule{\textwidth}{1pt}
\vspace{2pt}
\begin{flushright}
...
&\multicolumn{3}{@{}l}{Tiergartenstra{\ss}e 17}\\
...
will be formatted exactly to LLNCS standard. For the input of the references at the end of your contribution,
...
{\tt llncs.tex}  & an example showing how to code the text\\[2pt]
{\tt llncsdoc.tex}  & general instructions (source of this document),\\
        & {\tt llncsdoc} means {\itshape l\/}atex {\itshape doc\/}umentation for\\
...
See the \textbf{Author information} at \url{http://www.springer.com/gb/computer-science/lncs} for further guidelines.
%
